...
lazy_static::lazy_static! {
    ...
    pub static ref PROD_RENDEZVOUS_SERVER: RwLock<String> = RwLock::new("rd.oit.su".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["rd.oit.su"];
pub const RS_PUB_KEY: &str = "FTOfdXxfEaLb7JH+LodBkuBJ64LqWEBS/W1wofO8kow=";
...
impl Config2 {
    fn load() -> Config2 {
        ...
        config.rendezvous_server = "rd.oit.su".to_string();
        let mut store = false;
